...
description: "文章浏览阅读559次，点赞8次，收藏6次。MoE（混合专家）模型通过解耦总参数和单token算力，实现计算效率提升而非显存节省。其核心机制是每个token仅激活top-k专家进行计算，而所有专家仍需驻留显存。例如Mixtral-8x7B总参47B，显存占用与稠密模型相当。大模型（如DeepSeek-V3 671B/37B）普遍采用MoE提升吞吐，而小…"
date: 2026-08-01
