...
description: "文章浏览阅读361次，点赞3次，收藏6次。字节跳动大数据开发实习面试复盘：面试围绕技术基础、项目经历和算法能力展开。技术考察包括Java并发（线程创建、sleep/wait区别）、RPC框架实现（Netty应用、动态代理、零拷贝）、线程池配置等；项目深挖重点询问自研RPC框架的技术细节；算法题考察代码相似度判断。面试官肯定项目独立完成度，指出需提升技…"
date: 2026-05-19
